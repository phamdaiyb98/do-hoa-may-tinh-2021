//Chương trình vẽ Cánh tay robot theo mô hình lập trình OpenGL hiện đại
...
void base()
{
	...
	model_view *= Translate(0.0, 0.5*BASE_HEIGHT, 0.0)*Scale(BASE_WIDTH, BASE_HEIGHT, BASE_WIDTH);
...
void shaderSetup( void )
{
	...
	model_view_loc = glGetUniformLocation(program, "modelViewMatrix");
...
int main( int argc, char **argv )
{
    ...
    glutCreateWindow( "Table Controlling" );            
